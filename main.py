...
def work():
    ...
    for l in listr:
        ...
        try:
            proc = subprocess.Popen(["python3", converter_path, '-i', input_path, '-o', file_name_converted], stdout=subprocess.PIPE)
            proc.wait()
        except Exception as e:
        ...
        try:
            proc1 = subprocess.Popen(["python3", checker_path, '-i', file_name_converted, '-o', file_name_removedLines], stdout=subprocess.PIPE)
            proc1.wait()
        except Exception as e:
        ...
        try:
            proc2 = subprocess.Popen(["python3", seperator_path, '-i', file_name_removedLines, '-o', file_name_seperator], stdout=subprocess.PIPE)
            proc2.wait()
        except Exception as e:
