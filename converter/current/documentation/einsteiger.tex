...
%ersteSchritte001
\begin{figure}[htbp]
\includegraphics[width=1.1\textwidth]{ersteSchritte001}\par\vspace{0.25cm}
...
\newline
\begin{figure}[htbp]
\includegraphics[width=1.1\textwidth]{ersteSchritte1}\par\vspace{0.25cm}
%\caption{Aufruf der Hilfe mittels -h}
...
\end{center}
\begin{figure}[htbp]
\includegraphics[width=1.1\textwidth]{ersteSchritte2}\par\vspace{0.5cm}
%\caption{Aufruf der Hilfe mittels - -help}
\label{fig:ersteSchritte2}
\end{figure}\newpage
Die Ausgabe sollte wie folgt aussehen:
\begin{figure}[htbp]
\includegraphics[width=1.1\textwidth]{ersteSchritte3}\par\vspace{0.5cm}
%\caption{Aufruf der Hilfe mittels - -help}
